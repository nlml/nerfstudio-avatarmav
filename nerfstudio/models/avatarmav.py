...
@dataclass
class AvatarMAVModelConfig(ModelConfig):
    """AvatarMAV Model Config"""

    _target: Type = field(default_factory=lambda: AvatarMAVModel)
...
class AvatarMAVModel(Model):
    ...
    Args:
        config: AvatarMAV configuration to instantiate model
    """

    config: AvatarMAVModelConfig
