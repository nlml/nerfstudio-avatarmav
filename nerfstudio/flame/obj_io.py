# NOTE: This code is taken from Pytorch3D and hacked together to avoid
# Pytorch3D dependency.
...
def _load_materials(
    ...
    *,
    ...
    raise NotImplementedError("Material loading not implemented")
...
def _load_obj(
    ...
    *,
    ...
    if create_texture_atlas:
        raise NotImplementedError("Texture atlas creation not implemented here")
